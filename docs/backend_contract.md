...
## Authenticated admin read models
- `public.admin_dashboard_overview`
- `public.admin_customer_overview`
- `public.admin_listing_queue`
- `public.admin_dispute_queue`
- `public.admin_order_queue`
- `public.admin_audit_feed`

These views are intended for the web admin console and stay behind admin-capable RLS.
...
12. Admin settings edits persist through `admin_update_platform_settings(...)`, and admin views surface the current operational queue plus audit trail.
